...
import { datalyticsNormalizePassiveListenerOptions } from '../utils/passive-listeners';
import { fromEvent, iif, Observable, Subject, Subscription } from 'rxjs';
import { filter } from 'rxjs/operators';
import { datalyticsIsMobileOrTablet } from '../utils/pointer.utils';

/** Event options that can be used to bind an active, capturing event. */
const activeCapturingEventOptions = datalyticsNormalizePassiveListenerOptions({
    passive: false,
    capture: true
});
